...
public class BaseModel {
    ...
    public String formatDate(Date date) {
        ...
        boolean isChinese = locale.getDisplayLanguage().equalsIgnoreCase("chinese");
        if (isChinese) {
            if (date == null) return "";
            ...
            if (offset > YEAR) {
                ...
                return (offset / MONTH) + "Month ago";
            } else if (offset > WEEK) {
                return (offset / WEEK) + "Week ago";
            } else if (offset > DAY) {
                return (offset / DAY) + "Days ago";
            } else if (offset > HOUR) {
                return (offset / HOUR) + "An hour ago";
            } else if (offset > MINUTE) {
